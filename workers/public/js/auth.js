        ...
        regForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const regData = {
                    ...
                    banco_numero_cuenta: document.getElementById('reg-banco-cuenta')?.value || '',
                    banco_tipo_cuenta: document.getElementById('reg-banco-tipo')?.value || 'ahorros',
                    banco_nombre: document.getElementById('reg-banco-nombre')?.value || '',
                    banco_titular: document.getElementById('reg-banco-titular')?.value || '',
                    banco_celular: document.getElementById('reg-banco-celular')?.value || '',
