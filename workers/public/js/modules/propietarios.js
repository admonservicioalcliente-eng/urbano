                ...
                <div style="border:1px solid #333; padding:12px; border-radius:8px; margin:12px 0; background:#111; color:#fff;">
                    ...
                    <div style="margin-top:12px; display:flex; flex-direction:column; gap:8px; align-items:flex-start; width:100%; padding:0;">
                        ...
                        <div id="prop-celda-fields" style="display:${hasCelda ? 'flex' : 'none'}; gap:10px; flex-wrap:wrap; margin-left:22px; align-items:end;">
                            ...
                            <div class="form-group" style="margin:0;"><label style="color:#fff; text-align:left; display:block; margin-bottom:4px;">Valor Celda $</label><input type="number" step="1000" min="0" id="prop-valor-celda" value="${valCelda}" placeholder="0" oninput="window.NassauPropietarios.calcCuotaPreview()" style="background:#000; color:#fff; border:1px solid #444;"></div>
                        </div>
                    </div>
                    <div style="margin-top:12px; display:flex; flex-direction:column; gap:8px; align-items:flex-start; width:100%; padding:0;">
                        <label style="display:flex; align-items:center; gap:8px; justify-content:flex-start; width:100%; margin:0; padding:0; text-align:left;"><input type="checkbox" id="prop-has-cuarto" ${hasCuarto ? 'checked' : ''} onchange="window.NassauPropietarios.toggleInmueble('cuarto')" style="margin:0 8px 0 0; padding:0;"> Cuarto Útil</label>
