        ...
        return `
            ...
            <form id="prop-form" onsubmit="window.NassauPropietarios.savePropietario(event)" style="max-height:70vh; overflow-y:auto; padding-right:6px;">
                ...
                <div style="border:1px solid #333; padding:12px; border-radius:8px; margin:12px 0; background:#111; color:#fff;">
                    ...
                    <div style="margin-top:12px; display:flex; flex-direction:column; gap:8px; align-items:flex-start; width:100%;">
                        <label style="display:flex; align-items:center; gap:8px; justify-content:flex-start; width:100%; margin:0;"><input type="checkbox" id="prop-has-cuarto" ${hasCuarto ? 'checked' : ''} onchange="window.NassauPropietarios.toggleInmueble('cuarto')" style="margin:0;"> Cuarto Útil</label>
